// Global namespace
var UpsertInventoryController = UpsertInventoryController || {};

// Define constructor
UpsertInventoryController = function() {
	this.username = "";
	this.password = "";
...
UpsertInventoryController.prototype.isValid = function(name, type, value){
	var self = this;
...
UpsertInventoryController.prototype.cleanForm = function(){
	var self = this;
...
UpsertInventoryController.prototype.run = function(){
	var self = this;
		...
		self.password = $(self.SELECTOR.PASSWORD).val();
	  	...
	  	if(isValid){
			...
			// Uncomment this if API ready
	  		...
	  		console.log("[UpsertInventoryController][Login Spec]", spec);
...
var loginController = new UpsertInventoryController();
loginController.run();
